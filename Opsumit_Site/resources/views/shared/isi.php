...
<div class="isi_outer">
    <div class="isi_inner">
        ...
        <div id="isi_box_heading"><h4 class="isi_head_text">IMPORTANT SAFETY INFORMATION</h4><div id="boxed_warning"><h4>BOXED WARNING: EMBRYO-FETAL TOXICITY</h4>
                <ul>
                    <li><span class="li_block">■</span><p>Do not administer OPSUMIT to a pregnant female because it may cause fetal harm.</p></li>
                    <li><span class="li_block">■</span><p>Females of reproductive potential: Exclude pregnancy before the start of treatment, monthly during treatment, and 1 month after stopping treatment. Prevent during treatment and for one month after stopping treatment by using acceptable methods of contraception. </p></li>
        ...
        <div id="indication"><h4 class="isi_head_text">INDICATION</h4>
        ...
        <div id="isi_content">
            <h4 class="isi_head_text">CONTRAINDICATIONS</h4>Pregnancy: OPSUMIT may cause fetal harm when administered to a pregnant woman. OPSUMIT is contraindicated in females who are pregnant. If OPSUMIT is used during pregnancy, apprise the patient of the potential hazard to a fetus.
            <h4 class="isi_head_text">WARNINGS AND PRECAUTIONS</h4>
            <h4 class="isi_head_text">Embryo-fetal Toxicity and OPSUMIT REMS Program </h4><p></p> Due to the risk of embryo-fetal toxicity, OPSUMIT is available for females only through a restricted program called the OPSUMIT REMS Program. For females of reproductive potential, exclude pregnancy prior to initiation of therapy, ensure use of acceptable contraceptive methods, and obtain monthly pregnancy tests.</p>
            ...
            <h4 class="isi_head_text">Hepatotoxicity</h4>
                <ul>
                ...
                <h4 class="isi_head_text">Hemoglobin Decrease</h4>
                ...
                <h4 class="isi_head_text">DRUG INTERACTIONS</h4>
            <ul>
 ...
 <div id="isi_footer" class="isi_footer_outer">
    <div class="isi_footer_inner">
        ...
        <div id="isi_box_heading_footer"><h4 class="isi_head_text">IMPORTANT SAFETY INFORMATION</h4><div id="boxed_warning_footer"><h4>BOXED WARNING: EMBRYO-FETAL TOXICITY</h4>
                <ul>
        ...
        <div id="indication_footer"><h4 class="isi_head_text">INDICATION</h4>
            <p>OPSUMIT is an endothelin receptor antagonist (ERA) indicated for the treatment of pulmonary arterial hypertension (PAH, WHO Group I) to delay disease progression. Disease progression included: death, initiation of intravenous (IV) or subcutaneous prostanoids, or clinical worsening of PAH (decreased 6-minute walk distance, worsened PAH symptoms and need for additional PAH treatment). OPSUMIT also reduced hospitalization for PAH.</p>
           <p>Effectiveness was established in a long-term study in PAH patients with predominantly WHO Functional Class II-III symptoms treated for an average of 2 years. Patients were treated with OPSUMIT monotherapy or in combination with phosphodiesterase-5 inhibitors or inhaled prostanoids. Patients had idiopathic and heritable PAH (57%), PAH caused by connective tissue disorders (31%), and PAH caused by congenital heart disease with repaired shunts (8%).</p>
         </div>
