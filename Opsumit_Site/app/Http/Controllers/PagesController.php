...
class PagesController extends Controller
{
    ...
    public function seraphin_study(){
        ...
        return view('pages.seraphin_study', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function efficacy(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "Efficacy 2.0";
        return view('pages.efficacy', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function safety_profile(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "Safety Profile 3.0";
        return view('pages.safety_profile', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function about(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "About Opsumit 4.0";
        return view('pages.about', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function prescribing_opsumit(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "Prescribing Opsumit 5.0";
        return view('pages.prescribing', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function services_and_support(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "Services and Support 6.0";
        return view('pages.services', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }

    public function pah_resources(){
        $navItems = NavModel::getNavElements();
        $pageTitle = "PAH Resources 7.0";
        return view('pages.resources', ['navItems'=>$navItems, 'pageTitle'=>$pageTitle]);
    }
}
